    ...
    <div className="flex justify-between items-center mb-0.5 border-b-2 border-slate-900 pb-0.5">
      <div className="flex gap-2 items-center">
        ...
        <div className="flex flex-col">
          <span className="text-[12px] font-black leading-none uppercase text-slate-900">
            Hospital Hanga Roa
          </span>
      ...
      <div className="flex gap-2 items-center">
        <div className="flex flex-col items-end">
          <span className="text-[8px] font-bold text-slate-500 uppercase tracking-tighter text-right">
            Red Salud Oriente
          </span>
        </div>
        <img
          src="/images/logos/logo_SSMO.jpg"
          alt="Logo SSMO"
