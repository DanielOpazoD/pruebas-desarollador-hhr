...
const sectionErrorBoundaryLogger = createScopedLogger('SectionErrorBoundary');
...
export class SectionErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    sectionErrorBoundaryLogger.error(`Error in ${this.props.sectionName}`, {
      error,
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h4 className="font-medium text-red-800 mb-1">Error en {sectionName}</h4>
