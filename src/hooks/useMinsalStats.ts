...
export function useMinsalStats(
    ...
    const stats = useMemo(() => {
        ...
        return {
            ...
            mortalidadHospitalaria: remoteStats.mortalidadHospitalaria ?? localStats.mortalidadHospitalaria ?? 0,
            ...
            tasaOcupacionActual: (remoteStats as MinsalStatistics).tasaOcupacionActual || localStats.tasaOcupacionActual || 0,
            ...
            porEspecialidad: (localStats.porEspecialidad && localStats.porEspecialidad.length > 0)
