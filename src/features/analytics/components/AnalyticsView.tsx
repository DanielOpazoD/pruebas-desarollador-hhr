    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="text-sm text-slate-500 bg-slate-50 px-4 py-2 rounded-lg">
                Período: <span className="font-medium text-slate-700">{formatDateDDMMYYYY(stats.periodStart)}</span>
                {' → '}
                <span className="font-medium text-slate-700">{formatDateDDMMYYYY(stats.periodEnd)}</span>
                {' '}
