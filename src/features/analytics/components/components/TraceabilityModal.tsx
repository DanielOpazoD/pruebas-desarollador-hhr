                            ...
                            <tr>
                                {isGroupedView ? (
                                    <>
                                        ...
                                        <th className="pl-4 pr-8 py-3 font-medium text-slate-600 border-b text-center">Días en Periodo</th>
                                    </>
                                ) : (
                                    <>
                                        <th className="pl-8 pr-4 py-3 font-medium text-slate-600 border-b">Fecha Evento</th>
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {isGroupedView ? (
                                ...
                                uniquePatients.map((item, idx) => (
                                    <tr key={`${item.patient.rut}-${idx}`} className="hover:bg-slate-50 transition-colors">
                                ...
                                sortedPatients.map((p, idx) => (
                                    <tr key={`${p.rut}-${p.date}-${idx}`} className="hover:bg-slate-50 transition-colors">
                                        ...
                                        <td className="px-4 py-2.5 font-medium text-slate-800 align-top">
                                            {p.name}
                                        </td>
                                        <td className="px-4 py-2.5 text-slate-500 font-mono text-xs align-top">
                                            {p.rut}
