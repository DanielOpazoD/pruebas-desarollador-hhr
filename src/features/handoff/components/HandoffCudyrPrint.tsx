...
import { VerticalHeader, getCategorization } from '@/features/cudyr';
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 overflow-hidden print:shadow-none print:border-none print:p-0 print:rounded-none">
                <div className="overflow-x-auto print:overflow-visible">
                    <table className="w-full text-left text-xs border-collapse border border-slate-300 table-fixed min-w-[720px] print:table-auto print:min-w-0 print:text-[7px]">
                        <thead>
                            <tr>
                                <th colSpan={3} className="bg-slate-100 border border-slate-300 p-2 text-center font-bold text-slate-700 print:bg-white print:p-1">PACIENTE</th>
                            ...
                            <tr className="text-center">
                                ...
                                <th className="border border-slate-300 p-1 w-32 bg-slate-50 align-middle print:w-auto">NOMBRE</th>
                                <th className="border border-slate-300 p-1 w-20 bg-slate-50 align-middle print:w-auto">RUT</th>
                            ...
                            {visibleBeds.map((bed) => {
                                ...
                                if (!patient?.patientName) {
                                    return (
                                        ...
                                        >
                                            ...
                                            <td colSpan={16} className="border-r border-slate-300 p-1 text-center text-slate-400 italic text-[10px] print:text-[8px]">
                                                Cama disponible
                                            </td>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* Name Column */}
                                        <td className="border-r border-slate-300 p-1 font-medium text-slate-700 text-[10px] truncate max-w-[120px]" title={patient.patientName}>
                                            {patient.patientName}
                                        </td>
