var Mario = {
  ...
  Tile: {
    ...
    LoadBehaviors: function () {
      for (
        var a = [
            0, 20, 28, 0, 130, 130, 130, 130, 2, 2, 2, 2, 2, 0, 138, 0, 162, 146, 154, 162, 146,
  ...
  Level: function (a, b) {
    ...
    for (var c = 0, e = 0, c = 0; c < this.Width; c++) {
      ...
      for (e = 0; e < this.Height; e++)
        ((this.Map[c][e] = 0), (this.Data[c][e] = 0), (this.SpriteTemplates[c][e] = null));
    }
  },
};
...
Mario.ImprovedNoise.prototype = {
  ...
  Noise: function (a, b, c) {
    ...
    return this.Lerp(
      ...
      this.Lerp(
        h,
        this.Lerp(g, this.Grad(this.P[k], a, b, c), this.Grad(this.P[e], a - 1, b, c)),
        this.Lerp(g, this.Grad(this.P[j], a, b - 1, c), this.Grad(this.P[f], a - 1, b - 1, c))
      ),
      this.Lerp(
        h,
        this.Lerp(
...
Mario.Character.prototype.Blink = function (a) {
  ...
  this.Large
    ? ((this.Image = this.Fire ? Enjine.Resources.Images.fireMario : Enjine.Resources.Images.mario),
      (this.XPicO = 16),
      (this.YPicO = 31),
...
Mario.Character.prototype.Move = function () {
  if (this.WinTime > 0) (this.WinTime++, (this.Ya = this.Xa = 0));
    ...
    this.MayJump =
      (this.OnGround || this.Sliding) && !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S);
...
Mario.Character.prototype.SubMove = function (a, b) {
  ...
  if (a > 0)
    ((this.Sliding = !0),
      this.IsBlocking(this.X + a + this.Width, this.Y + b - this.Height, a, b)
        ? (c = !0)
        : (this.Sliding = !1),
      this.IsBlocking(this.X + a + this.Width, this.Y + b - ((this.Height / 2) | 0), a, b)
        ? (c = !0)
        : (this.Sliding = !1),
  ...
  if (c) {
    ...
    if (a > 0)
      ((this.X = (((this.X + this.Width) / 16 + 1) | 0) * 16 - this.Width - 1), (this.Xa = 0));
    if (b < 0)
...
Mario.LevelRenderer.prototype.DrawStatic = function (a, b) {
  for (
    var c = 0, e = 0, d = 0, d = null, f = ((b.X + this.Width) / 16) | 0, c = (b.X / 16) | 0;
    c < f + 1;
    c++
  )
    ...
    for (e = (b.Y / 16) | 0; (e <= (b.Y + this.Height) / 16) | 0; e++)
      ((d = this.Level.GetBlock(c, e)),
        (Mario.Tile.Behaviors[d & 255] & Mario.Tile.Animated) > 0 &&
          ...
          (((d % 16) / 4) | 0) === 0 &&
            ((d / 16) | 0) === 1 &&
            ((f = ((this.Bounce / 2 + (c + e) / 8) | 0) % 20), f > 3 && (f = 0)),
      ...
      if (((Math.random() * 35) | 0) < this.Difficulty + 1)
        ((f = (Math.random() * 4) | 0),
          ...
          a.SetSpriteTemplate(
            d,
            e,
            new Mario.SpriteTemplate(f, ((Math.random() * 35) | 0) < this.Difficulty)
          ));
  },
  BuildTubes: function (a, b, c) {
    ...
    for (h = b; h < b + e; h++) {
      ...
      h === f &&
        ...
        a.SetSpriteTemplate(h, g, new Mario.SpriteTemplate(Mario.Enemy.Flower, !1));
      for (i = 0; i < this.Height; i++)
        if (i >= d) a.SetBlock(h, i, 145);
        else if ((h === f || h === f + 1) && i >= g)
          ((j = 10 + h - f), i === g ? a.SetBlock(h, i, j) : a.SetBlock(h, i, j + 16));
    }
    return e;
  },
...
Mario.LoadingState.prototype.CheckForChange = function (a) {
  if (this.ImagesLoaded)
    ((Mario.GlobalMapState = new Mario.MapState()), a.ChangeState(new Mario.TitleState()));
};
...
Mario.MapState.prototype.Travel = function (a, b, c, e) {
  if (!(this.Level[a][b] !== Mario.MapTile.Road && this.Level[a][b] !== Mario.MapTile.Level)) {
    ...
    if (this.Level[a][b] === Mario.MapTile.Level)
      if (this.Data[a][b] > 0)
        this.Data[a][b] =
          this.LevelId !== 0 && ((Math.random() * 4) | 0) === 0 ? -3 : ++this.LevelId;
...
Mario.MapState.prototype.TryWalking = function (a, b) {
  var c = (this.XMario / 16) | 0,
    ...
    f = e + b;
  if (
    (this.Level[d][f] === Mario.MapTile.Road || this.Level[d][f] === Mario.MapTile.Level) &&
    !(
...
Mario.MapState.prototype.LevelWon = function () {
  ...
  this.Data[a][b] === -2
    ? this.NextWorld()
    : ((this.Data[a][b] = this.Data[a][b] !== -3 ? 0 : -10), this.RenderStatic());
};
...
Mario.LevelState.prototype.Update = function (a) {
    ...
    for (b = this.ShellsToCheck.length = 0; b < this.FireballsToCheck.length; b++)
      for (c = 0; c < this.Sprites.Objects.length; c++)
        this.Sprites.Objects[c] !== this.FireballsToCheck[b] &&
          ...
          this.Sprites.Objects[c].FireballCollideCheck(this.FireballsToCheck[b]) &&
  ...
  this.Camera.X =
    Mario.MarioCharacter.XOld + (Mario.MarioCharacter.X - Mario.MarioCharacter.XOld) * a - 160;
  this.Camera.Y =
    Mario.MarioCharacter.YOld + (Mario.MarioCharacter.Y - Mario.MarioCharacter.YOld) * a - 120;
};
Mario.LevelState.prototype.Draw = function (a) {
  ...
  this.StartTime > 0 &&
    ((b = this.StartTime + this.Delta - 2), this.RenderBlackout(a, 160, 120, (b * b * 0.6) | 0));
  ...
  if (Mario.MarioCharacter.DeathTime > 0) {
    ...
    if (
      b > 900 &&
      (Mario.MarioCharacter.Lives--, (this.GotoMapState = !0), Mario.MarioCharacter.Lives <= 0)
    )
